...
#define getfid_enum(e) template<> int getfid<e##_s>(e##_s value) { return e##_data[value].fid; }
...
template<class T> int				getfid(T e); // Template to return string of small class
